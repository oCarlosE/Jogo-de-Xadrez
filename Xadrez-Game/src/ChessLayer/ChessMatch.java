...
import ChessLayer.ChessPieces.Bishop;
import ChessLayer.ChessPieces.King;
import ChessLayer.ChessPieces.Knight;
import ChessLayer.ChessPieces.Pawn;
import ChessLayer.ChessPieces.Queen;
...
public class ChessMatch {
	...
	public ChessPiece replacePromotedPiece(String string){
		if(promoted== null){
			throw new ChessException("Não é possivel promover uma peça.");
		}
		if(!string.equals("Q") && !string.equals("N") && !string.equals("B") && !string.equals("R")){
			throw new ChessException("Tipo de Peça Invalido.");
		}
